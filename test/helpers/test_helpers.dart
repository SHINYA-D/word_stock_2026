...
/// テスト用フォルダ一覧
final testFolders = [
  Folder(id: 'folder-1', name: '英単語', createdAt: DateTime(2024, 1, 1)),
  Folder(id: 'folder-2', name: 'TOEIC 頻出', createdAt: DateTime(2024, 1, 2)),
];

/// テスト用単語一覧
final testWords = [
  Word(id: 'word-1', front: 'apple', back: 'りんご', createdAt: DateTime(2024, 1, 1)),
  Word(id: 'word-2', front: 'banana', back: 'バナナ', createdAt: DateTime(2024, 1, 2)),
  Word(id: 'word-3', front: 'cherry', back: 'さくらんぼ', createdAt: DateTime(2024, 1, 3)),
];
