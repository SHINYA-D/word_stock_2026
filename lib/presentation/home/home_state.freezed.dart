...
/// @nodoc
mixin _$HomeState {
  AsyncValue<List<Folder>> get folders;
  ...
  @override
  String toString() {
    return 'HomeState(folders: $folders)';
  }
}
...
abstract mixin class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AsyncValue<List<Folder>> folders});
}
...
extension HomeStatePatterns on HomeState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(AsyncValue<List<Folder>> folders)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _HomeState() when $default != null:
        return $default(_that.folders);
      case _:
        return orElse();
    }
  }
...
class _HomeState implements HomeState {
  const _HomeState({required this.folders});
